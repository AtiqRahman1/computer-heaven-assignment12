        ...
        <div>
            ...
            <div className='flex h-screen justify-center mt-20'>
                <form className="card w-96 bg-base-100 shadow-xl">
                    ...
                    <br />
                    <input type="text" name='product' placeholder='Education' className="input input-bordered input-info w-full max-w-xs mt-4" />
                    <input type="text" name='quantity' placeholder="LinkedIn Profile" className="input input-bordered input-info w-full max-w-xs mt-4" />
